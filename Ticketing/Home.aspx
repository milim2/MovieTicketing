            ...
            <article class="auto-style3">
                ...
                <table class="auto-style7" style="margin-left: auto; margin-right: auto">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="movie_ddl" runat="server" AutoPostBack="True" Width="139px">
                    ...
                    <tr>
                        ...
                        <td>                              
                            &nbsp;<asp:TextBox ID="tbDate" runat="server" TextMode="Date" Width="171px"></asp:TextBox>                          
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style8">Select Time</td>
                        <td>
                            <asp:TextBox ID="tbTime" runat="server" Width="172px" TextMode="Time"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style8">
                            <asp:LinkButton ID="lb_submit" runat="server" BackColor="#0080FF" 
                                BorderColor="#0080FF" BorderStyle="Solid" ForeColor="White">Submit</asp:LinkButton>
                        </td>
                        <td>
                        ...
                        <table style="text-align: center">
                            <tr>
                                <td style="font-family: Arial, Helvetica, sans-serif; 
                                          font-size: x-large; color: #0080FF; font-weight: normal">Coming SOON</td>
                            </tr>
                            <tr>
                                <td>
                                    <img alt="Avangers Endgame" class="auto-style9" 
                                        src="images/sm_sm_avangersEndGame.jpg" style="text-align: center" /></td>
                            </tr>
                        </table>
            </article>
            <section class="w3-container">
                <h1 style="font-family: Arial, Helvetica, sans-serif; font-size: x-large; text-align: center;">&nbsp;</h1>
                <h1 style="font-family: Arial, Helvetica, sans-serif; font-size: x-large; ">
